...
- 本番はVercel(https://unyatask.vercel.app、GitHub: https://github.com/miacci0/unyatask )にデプロイ済み。デプロイ環境の環境変数(`NEXT_PUBLIC_SUPABASE_URL` / `NEXT_PUBLIC_SUPABASE_ANON_KEY`)は上記のローカル用と同じ値。
